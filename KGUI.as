...
class GenericGUIItem : IGUIItem{
	...
	void dispToolTip()
	{
		...
		if(toolTip != ""){
			GUI::DrawTranslatedText(toolTip + "\n",mouseScrPos,mouseScrPos + Vec2f((toolTip.length/7)*8,0),tipColor,true,true,true);
		}
	}
