...
float drawServerInfo(float y)
{
    ...
    string info = getTranslatedString(rules.gamemode_info);
    Vec2f dim;
    ...
    mid.y += 15;
    GUI::DrawTextCentered("To search for a ranked match,", mid, white);
    mid.y += 20;
    GUI::DrawTextCentered("click the button on the right!", mid, white);
